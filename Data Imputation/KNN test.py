"""This script conduct a test to figure out the best k value in the KNN method."""
...
test = pd.DataFrame(columns=['Accuracy', 'F1 Score','Neighbour'])
...
for n in range(1,440):
    ...
    # Append the results to the 'test' DataFrame
    test = test._append({'Accuracy': accuracy, 'F1 Score': f1, 'Neighbour': n}, ignore_index=True)

# Specify the path and filename for the CSV file
csv_path = 'KNN Parameter.csv'
